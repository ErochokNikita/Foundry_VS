...
async def main() -> None:
    async with (
        ...
        AIProjectClient(endpoint="https://neues-setup-resource.services.ai.azure.com/api/projects/neues-setup", credential=credential) as project_client,
        ChatAgent(
            chat_client=AzureAIClient(
                project_client=project_client,
                agent_name="KompetenzenExt",
